...
<script src="${pageContext.request.contextPath}/js/room/room.js"></script>
    ...
    <script src="${pageContext.request.contextPath}/js/TimeDifference.js"></script>
</head>
                ...
                <div class="nav-list" >
                    <ul>
                        ...
                        <li class="nav-left-dropdown">
                            ...
                            <ul class="nav-left-dropdown-menu">
                                <li><a href="${pageContext.request.contextPath}/showAllUsers/1">编辑客房</a></li>
                 ...
                 <div class="col-md-6 roomDetail">
                        ...
                        <div class="panel-body">
                            <form>
                                <div class="form-group newRoomTypeInp">
                                    <label for="exampleInputEmail1">类型名</label>
                                    <input type="text" name="roomNumber" class="form-control roomTypeNameDetail" disabled/>
                                </div>
                                <div class="form-group newRoomTypeInp">
                                    <label for="exampleInputEmail1">房间号</label>
		    ...
		    <div class="col-md-6 logistics" >
               ...
               <div class="col-md-6 reservation">
                      ...
                      <div class="panel-body">
                          ...
                          <input type="hidden" name="roomId" class="roomIdInp">
                         	 <input type="hidden" name="staffId" value="${sessionScope.staff.staffId}">
                              <input type="hidden" name="roomTypeId" value="${requestScope.roomTypeId}">
                         	 <div class="form-group newRoomTypeInp">
                                  <label for="exampleInputEmail1">房间号</label>
                              ...
                              <div class="form-group newRoomTypeInp">
                                  ...
                                  <input type="datetime-local" name="expectedTimeOfArrival"  class="form-control roomStoreyDetail upTime" />
                              </div>
                              <div class="form-group newRoomTypeInp">
                                  <label for="exampleInputEmail1">预离时间</label>
                                  <input type="datetime-local" name="estimatedTimeOfDeparture" class="form-control roomStoreyDetail outTime"/>
                              </div>
                              <div class="form-group newRoomTypeInp">
                              ...
                              <div class="form-group newRoomTypeInp">
                                  ...
                                  <input type="text" name="reservationOccupancyDays" class="form-control roomWindowDetail upOutTime"/>
                              </div>
                              <div class="form-group newRoomTypeInp">
                              ...
                              <div class="form-group newRoomTypeInp">
                                  ...
                                  <input type="text" name="reservationForegift" class="form-control" value="${roomType.reservationForegift}"/>
                              </div>                              
                              <div class="newRoomTypeFooter">
               ...
               <div class="col-md-6 reservationDetail">
                      ...
                      <div class="panel-body">
                          <form >
                              ...
                              <div class="form-group newRoomTypeInp">
                                  <label for="exampleInputEmail1">预计离店时间</label>
                                  <input type="text" name="estimatedTimeOfDeparture" disabled="disabled" class="form-control estimatedTimeOfDepartureDetail" />
                              </div>
                              <div class="form-group newRoomTypeInp">
               ...
               <div class="col-md-6 checkIn">
                    ...
                    <div class="checkInBtn">
                        ...
                        <input type="hidden" name="reservationId" class="reservationIdInp" value="0">
                            ...
                            <div class="form-group checkInInp">
                                <label for="exampleInputEmail1">应收房款(押金抵消部分房款)</label>
             ...
             <!-- 退房登记 -->
               <div class="col-md-6 checkOut">
                 ...
                 <div class="footer">
                <a href="${pageContext.request.contextPath}/showAllRoom/${requestScope.roomTypeId}" class="countRoom" id="${requestScope.countRoomType}"><p class="span0">全部</p><br/>(${requestScope.countRoomType})</a>
				<a href="${pageContext.request.contextPath}/showRoomStruts/5/${requestScope.roomTypeId}"/><p class="span2" style="color: #000">预订<br/>(${requestScope.countReservationRoomType})</p></a>
