...
<meta charset="UTF-8">
<title>用户登录</title>
		<link rel="stylesheet" href="${pageContext.request.contextPath}/css/client/clientRegist.css"/>
		...
		<script type="text/javascript">
			$(function(){
				...
				$(".getMessage").click(function(){
					...
					alert(clientPhone);
					$.post("${pageContext.request.contextPath}/getMessage/"+clientPhone,function(data){
						if(data != "error"){
							alert("发送成功，请注意查看短信");
...
<body>
	<form action="${pageContext.request.contextPath}/clientRegist" method="post">
		<div class="main">
			...
			<div class="section">
				<div class="client">
					<img src="${pageContext.request.contextPath}/img/user.png" class="clientLogo"/>
				...
				<div class="client">
					<img src="${pageContext.request.contextPath}/img/user.png" class="clientLogo"/>
					<input type="text" id="names" class="clientIdCard" name="clientIdCard" autocomplete="off" placeholder="请输入您的身份证号"/><span></span>
				</div>
				<div class="client">
					<img src="${pageContext.request.contextPath}/img/user.png" class="clientLogo"/>
					<input type="text" id="names" class="clientPhone" name="clientPhone" autocomplete="off" placeholder="请输入您的手机号码"/><span></span>
