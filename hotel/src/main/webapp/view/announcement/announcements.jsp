                    ...
                    <div class="panel panel-default ">
                        ...
                        <div class="panel-body">
                          <form action="${pageContext.request.contextPath}/updateAnnouncement" method="post">
                                <div class="form-group announcementText">
                                    <label for="exampleInputEmail1">标题</label>
                                    <input type="text" name="announcementTitle" class="form-control announcementTitleDetail" id="exampleInputEmail1" disabled/>
                                </div>
                                <div class="form-group announcementText">
                                    <label for="exampleInputEmail1">发布时间</label>
                                    <input type="text" name="announcementTitle" class="form-control announcementTimeDetail" id="exampleInputEmail1" disabled/>
                                </div>
                                <div class="form-group announcementText">
                                    <label for="exampleInputEmail1">公告类型</label>
                                    <input type="text"  class="form-control announcementTypeDetail" id="exampleInputEmail1" disabled/>
                                </div>
                                <div class="form-group announcementText">
                                    <label for="exampleInputEmail1">公告状态</label>
                                    <input type="text"  class="form-control announcementStateDetail" id="exampleInputEmail1"  disabled/>
                                </div>                          
                                <div class="form-group announcementTextarea">
                                    <label for="exampleInputPassword1">内容</label>
                                    <textarea class="form-control announcementContentDetail" id="exampleInputPassword1" rows="4" cols="2" disabled></textarea>
                                </div> 
                                <div class="form-group announcementStaff">
