...
public interface CheckInDAO {
	 ...
	 * @return
	 */
	@Select("select checkinId from checkin where roomId=#{roomId}")
	 ...
	 * @return
	 */
	@Update("insert into checkin (roomId,roomTypeId,staffId,usersId,clientId,checkinTime,departureTime,checkinDay,checkinForegift) " +
			"value (#{roomId},#{roomTypeId},#{staffId},#{usersId},#{clientId},#{checkinTime},#{departureTime},#{checkinDay},#{checkinForegift})")
